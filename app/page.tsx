        ...
        <div className='flex justify-center md:justify-start'>
          <div className='mx-4 flex flex-col justify-center text-center md:mx-0 md:text-left'>
            <h1 className='text-2xl font-semibold text-neutral-900 md:text-4xl'>
              Hi, I'm <span className='relative animate-[--color-shift] text-red-900 filter hue-rotate-180'>
                        Benjamin Roget
                        <span className={`absolute top-0 left-0 w-full h-full animate-[--ping-text] rounded-full opacity-75 gradient-text text-2xl text-center flex justify-center items-center`}>
                          Benjamin Roget
                        </span>
                      </span>
            </h1>
