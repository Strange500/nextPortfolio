  ...
  return (
    <section className='h-full w-screen bg-[--white-transparent]'>
      ...
      <div className='container mx-auto'>
          ...
          <Card className='bg-white shadow-md'>
            <CardContent className='pt-3'>
              <div className='flex flex-col items-center justify-center md:flex-row'>
                <article className='flex items-center justify-center md:w-1/2 pr-2'>
                  <p className='text-justify'>
                    ...
                    Python, C, and JavaScript/TypeScript, as well as experience
                    with tools such as Docker, Podman, git, I use also frameworks like Next.js, and TailwindCSS.
                    I also have hands-on experience in
                    server configuration and database management.
                  </p>

                </article>
                <section className='grid grid-cols-3 gap-4 pt-3 md:w-1/2 md:pl-2 border-l-2 border-neutral-900'>
        ...
        >
          <Button className='relative rounded p-2 text-white shadow hover:bg-neutral-900'>
            <h2>
              See my projects
